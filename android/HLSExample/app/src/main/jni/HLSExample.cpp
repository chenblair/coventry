...
extern "C" JNIEXPORT void Java_com_superpowered_hlsexample_MainActivity_SetDownloadStrategy(JNIEnv * __unused javaEnvironment, jobject __unused obj, jint optionIndex) {
    switch (optionIndex) {
        case 1: player->downloadSecondsAhead = 0; break; // Will not buffer more than 20 seconds ahead of the playback position.
        case 2: player->downloadSecondsAhead = 1; break; // Will not buffer more than 40 seconds ahead of the playback position.
